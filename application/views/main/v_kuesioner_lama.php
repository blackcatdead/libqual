  ...
  <section class="content">
    ...
    <div class="box box-default">
    	<div class="box-header with-border">
          <h3 class="box-title">Kuesioner Persepsi</h3>
        </div><!-- /.box-header -->
    	<form method="post" action="<?php echo site_url() ?>main/submitkuesioner/1">
        <div class="box-body">
...
<!-- 	              <th style="width: 40px" class="danger"><center>STPT</th>
	              <th style="width: 40px" class="danger"><center>TPT</th>
	              <th style="width: 40px" class="danger"><center>CPT</th>
	              <th style="width: 40px" class="danger"><center>PT</th>
	              <th style="width: 40px" class="danger"><center>SPT</th> -->
	            </tr>
	            <?php $temp_id=0; ?>
